...
jQuery('.portfolio-item .image-box-content a').click(function(event) {
    ...
    if (lawyerLink.indexOf('greg') >= 0 || lawyerLink.indexOf('cheryl') >= 0 || lawyerLink.indexOf('aaron') >= 0 || lawyerLink.indexOf('felicia') >= 0 || lawyerLink.indexOf('robin') >= 0 || lawyerLink.indexOf('noela') >= 0) {
